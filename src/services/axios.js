...
axiosInstance.interceptors.response.use(
    ...
    async function (error) {
      ...
      console.log("in axiosInstance | BEGINING OF ERROR SECTION | error: ", error.response.data)
      console.log("in axiosInstance | BEGINING OF ERROR SECTION | error: ", error.response.status)
